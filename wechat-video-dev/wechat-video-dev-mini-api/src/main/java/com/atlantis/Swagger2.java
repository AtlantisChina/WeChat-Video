...
public class Swagger2 {
    /**
     * @Description:Swagger2的配置文件，配置Swagger2的一些基本的内容，比如扫描的包
     */
    @Bean
    public Docket createRestApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select()
                .apis(RequestHandlerSelectors.basePackage("com.atlantis.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                // 设置联系人
                .contact(new Contact("Atlantis", "http://www.atlantis.show", "atlantis.work@qq.com"))
                // 描述
