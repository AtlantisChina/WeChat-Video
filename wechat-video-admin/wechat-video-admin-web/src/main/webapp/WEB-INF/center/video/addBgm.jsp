	                    ...
	                    <form id="addBgmForm" class="form-horizontal">
		                    <div class="form-body">
		                    	...
		                    	<div class="form-group">
		                            ...
		                            <div class="col-md-4">
		                            	<div id="input-error">
		                            		<input id="author" name="author" type="text" class="form-control" placeholder="1-10字">
		                            	</div>
									</div>
								</div>
								...
								<div class="form-group">
		                        	<label class="col-md-3 control-label"><span class="field-required"> * </span>音乐文件</label>
		                            <div class="col-md-4">
		                            	<div id="input-error">
